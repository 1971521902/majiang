var GameConfig = /** @class */ (function () {
    ...
    GameConfig.prototype.recursDom = function (node, group) {
    ...
    GameConfig.prototype.recursNode = function (node, group) {
    ...
    GameConfig.prototype.getLen = function (obj) {
        var count = 0;
        if (obj.length != null) {
            return obj.length;
        }
    ...
    GameConfig.prototype.getCfg = function (key) {
        return this.data[key];
    };
    GameConfig.prototype.getConfigById = function (key, id) {
