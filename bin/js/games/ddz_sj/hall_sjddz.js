...
var Hallddz = ui.sjddz.hall_sjddzUI;
...
var gameView;
(function (gameView) {
    var hall_sjddz = /** @class */ (function () {
        /*  俱乐部  */
        function hall_sjddz(data) {
            this.data = data;
            new yftools.Loading([
                "res/atlas/ddz.atlas",
        ...
        hall_sjddz.prototype.onLoaded = function () {
            //  showloading()       //  加载中暂时的
            if (this.haveRoom) {
                return;
            }
        ...
        hall_sjddz.prototype.getFitGame = function (yxb, data) {
            for (var k in data) {
        ...
        hall_sjddz.prototype.gold_session = function (data) {
            var self = this;
        ...
        hall_sjddz.prototype.onclick = function (e) {
            ...
            if (name == "createRoom") {
                ...
                if (window["videoAd"]) {
                    window["videoAd"].load()
                        .then(function () { return window["videoAd"].show(); })
        ...
        hall_sjddz.prototype.notice = function () {
        ...
        hall_sjddz.prototype.setting_sjddz = function () {
        ...
        hall_sjddz.prototype.HSlider = function (skin) {
            if (skin === void 0) { skin = null; }
            console.log(132456);
        };
        hall_sjddz.prototype.ranking = function (data) {
            var self = this;
            ...
            if (data["list"] && data["list"].length > 0) {
                ...
                history_jilu.renderHandler = new Handler(this, function (cell, index) {
        ...
        //     })
        // }
        hall_sjddz.prototype.Dailyshare_activity = function (data) {
            ...
            for (var k = 1; k <= 5; k++) {
                ...
                addClick(seekByName(hongbao_bg, "lignqu_" + k), function (e) {
                    if (window["shareBTN"]) {
        ...
        hall_sjddz.prototype.zhuan_card_activity = function (data) {
            ...
            for (var k = 1; k <= 4; k++) {
                ...
                addClick(seekByName(hongbao_bg, "qiangwang" + k), function (e) {
        ...
        hall_sjddz.prototype.share_gold = function (data) {
            if (data === void 0) { data = null; }
            var share_gold = new ui.sjddz.share_goldUI();
        ...
        hall_sjddz.prototype.conversion = function (data) {
            var _this = this;
            var self = this;
            ...
            shoplist.renderHandler = new Handler(this, function (cell, index) {
                console.log("进入");
                if (index > data[arr[index]].length)
                    return;
                var content = data[arr[index]];
        ...
        hall_sjddz.prototype.drawTextu = function () {
            console.log("排行榜");
        ...
        hall_sjddz.prototype.phb_envelope = function (data) {
            var self = this;
            var is_temp = true;
            var sprite;
            ...
            for (var k = 1; k <= 3; k++) {
                addClick(seekByName(envelope, "button_" + k), function (e) {
                    // 清空
                    ...
                    if (is_temp) {
                        ...
                        else if (e.target.name == "button_1") {
                            sprite = self.drawTextu();
                            seekByName(envelope, "RankingList").visible = false;
                            seekByName(envelope, "zanweikaifang").visible = true;
        ...
        hall_sjddz.prototype.paihangbang = function (envelope, smoney, is_temp) {
            var _this = this;
            var shangbang = 0;
            ...
            RankingList.renderHandler = new Handler(this, function (cell, index) {
                if (index > smoney.length)
                    return;
                var data_any = _this.envelope_button[index];
                var num = index + 1;
                if (data_any) {
        ...
        hall_sjddz.prototype.showEnter = function () {
        ...
        hall_sjddz.prototype.isOpen = function (game_type, idx) {
            var self = this;
            var gameType = {
                "yzmj": (_a = {}, _a[0] = true, _a[1] = true, _a),
                "cardniuniu": (_b = {}, _b[0] = true, _b[1] = true, _b),
                "cardsjddz": (_c = {}, _c[0] = true, _c[1] = true, _c),
                "cardnddz": (_d = {}, _d[0] = true, _d[1] = true, _d),
                "bqmj": (_e = {}, _e[0] = true, _e[1] = true, _e)
            };
            var tempgame = gameType[game_type] && (gameType[game_type][idx] && gameType[game_type][idx] || false) || false;
            return tempgame;
            var _a, _b, _c, _d, _e;
        };
        hall_sjddz.prototype.showCreate = function (num) {
        ...
        hall_sjddz.prototype.roomPanel = function (idx) {
        ...
        hall_sjddz.prototype.packet = function (data) {
            var self = this;
        ...
        hall_sjddz.prototype.is_fuhuo = function (data) {
            var self = this;
            ...
            addClick(fuhuo.employ, function () {
        ...
        hall_sjddz.prototype.recvData = function (cmd, data) {
            ...
            else if (cmd == protocol.user_sjddz_yaoqing) {
                this.Dailyshare_activity(data);
            }
            else if (cmd == protocol.user_sjddz_share_new_fuhuoka) {
            ...
            else if (cmd == protocol.user_hudong_gold_server) {
                this.gold_session(data); // award 红包  底分 base  num 局数     online_num 在线人数    start最低多少分进入      stop  最高多少分
            }
            else if (cmd == protocol.user_get_ranking) {
                this.ranking(data);
            }
            else if (cmd == protocol.user_get_resurrection) {
                if (data) {
                    // showTip("新增"+ data+ "复活卡")
            ...
            else if (cmd == protocol.user_sjddz_duihuanfangka) {
            }
            else if (cmd == protocol.user_sjddz_paihangbang) {
        ...
        hall_sjddz.prototype.updateUI = function (key, data) {
            if (key == "enter") {
                runScene(gameView.GameScene, data);
            }
    ...
    gameView.hall_sjddz = hall_sjddz;
})(gameView || (gameView = {}));
var Item = /** @class */ (function (_super) {
    ...
    function Item() {
        ...
        _this.size(122, 55);
        _this.button = new Btn();
        _this.centerX = 0;
        _this.sel = false;
        _this.gName = new Lab("");
        _this.gName.fontSize = 24;
        _this.gName.centerX = 0.5;
        _this.gName.centerY = 0.5;
        _this.addChild(_this.button);
        _this.button.addChild(_this.gName);
        return _this;
    }
    ...
    Item.prototype.setSelected = function (sel) {
        this.button.selected = sel;
        this.sel = sel;
    };
    Item.prototype.isSel = function () {
        return this.sel;
    };
    return Item;
}(Box));
//# sourceMappingURL=hall_sjddz.js.map