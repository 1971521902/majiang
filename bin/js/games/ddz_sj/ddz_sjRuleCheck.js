var games;
(function (games) {
    var ddz_sjRuleCheck = /** @class */ (function () {
        function ddz_sjRuleCheck(arg) {
            this.data = arg;
            this.DDZCardType = {
                dan_zhang: 1,
                dan_dui: 2,
        ...
        ddz_sjRuleCheck.prototype.getType = function (card) {
            var onenum = 0;
            var twonum = 0;
            var sannum = 0;
            var sinum = 0;
            ...
            if (card.length == 1 && onenum == 1) {
                return this.DDZCardType["dan_zhang"];
            }
            else if (card.length == 1 && twonum == 1) {
                return this.DDZCardType["dan_dui"];
            }
            else if (twonum >= 3 && onenum == 0 && sannum == 0 && sinum == 0) {
            ...
            else if (onenum >= 5 && twonum == 0 && sannum == 0 && sinum == 0) {
                var temp = card[0].value;
                for (var k = 0; k < card.length; k++) {
                    if (temp == card[k].value) {
                        temp++;
            ...
            else if (onenum == 0 && twonum == 0 && sannum == 1 && sinum == 0) {
                return this.DDZCardType["san_zhang"];
            }
            else if (sannum == 1 && sinum == 0 && onenum == 1 && twonum == 0) {
                return this.DDZCardType["san_dai1"];
            }
            else if (sannum == 1 && sinum == 0 && onenum == 0 && twonum == 1) {
                return this.DDZCardType["san_dai2"];
            }
            else if (sannum + sinum >= 2) {
                return this.DDZCardType["fei_ji"];
            }
            else if (sinum == 1 && sannum == 0 && ((twonum == 0 && onenum == 2) || (twonum == 1 && onenum == 0))) {
                return this.DDZCardType["si_dai_1"];
            }
            else if (sinum == 1 && sannum == 0 && twonum == 2 && onenum == 0) {
                return this.DDZCardType["si_dai_2"];
            }
            else if (card.length == 1 && card[0].num == 4) {
                return this.DDZCardType["zhan_dan"];
            }
            else if (card.length == 2 && card[0].card[0] == "gui1" && card[1].card[0] == "gui2") {
        ...
        ddz_sjRuleCheck.prototype.changRuleData = function (data) {
            var data_list = [];
        ...
        ddz_sjRuleCheck.prototype.getCanPassCard = function (last, poker) {
        ...
        ddz_sjRuleCheck.prototype.cardRule = function (lastcardRule, userpokerRule) {
            var cartype = this.getType(lastcardRule);
            var temp = null;
            if (cartype == this.DDZCardType["dan_zhang"]) {
                temp = this.sangle(lastcardRule, userpokerRule);
            }
            else if (cartype == this.DDZCardType["dan_dui"]) {
                temp = this.sangle2(lastcardRule, userpokerRule);
            }
            else if (cartype == this.DDZCardType["lian_dui"]) {
                temp = this.liandui(lastcardRule, userpokerRule);
            }
            else if (cartype == this.DDZCardType["shun_zi"]) {
                temp = this.shunzi(lastcardRule, userpokerRule);
            }
            else if (cartype == this.DDZCardType["san_dai1"]) {
                temp = this.sanzhang1(lastcardRule, userpokerRule);
            }
            else if (cartype == this.DDZCardType["san_dai2"]) {
                temp = this.sanzhang2(lastcardRule, userpokerRule);
            }
            else if (cartype == this.DDZCardType["si_dai_1"]) {
                temp = this.sidai1(lastcardRule, userpokerRule);
            }
            else if (cartype == this.DDZCardType["si_dai_2"]) {
                temp = this.sidai2(lastcardRule, userpokerRule);
            }
            else if (cartype == this.DDZCardType["fei_ji"]) {
        ...
        ddz_sjRuleCheck.prototype.wangzha = function (userpokerRule) {
            var result_list = [];
            var netdata = [];
        ...
        ddz_sjRuleCheck.prototype.zhadan = function (lastcardRule, userpokerRule) {
            var result_list = [];
        ...
        ddz_sjRuleCheck.prototype.feiji = function (lastcardRule, userpokerRule) {
            var result_list = [];
            var feijiLenth = 0;
            var bijiaovalue = 0;
            var shoupaicount = 0;
        ...
        ddz_sjRuleCheck.prototype.getFeijicibangdan = function (userpokerRule, result_list, tnetdata, count, feijitou) {
        ...
        ddz_sjRuleCheck.prototype.getFeijicibangddui = function (userpokerRule, result_list, tnetdata, count, feijitou) {
            var findtemp = function (list, temp) {
                for (var k in list) {
                    if (list[k] == temp) {
                        return true;
        ...
        ddz_sjRuleCheck.prototype.feijidai2 = function (luojidata, cardcount) {
            var allvalue = [];
            var oncevalue = [];
            var temp = null;
            var num = 0;
        ...
        ddz_sjRuleCheck.prototype.feijidai1 = function (luojidata, cardcount) {
            var allvalue = [];
            var oncevalue = [];
            var temp = null;
            var num = 0;
        ...
        ddz_sjRuleCheck.prototype.sidai2 = function (lastcardRule, userpokerRule) {
            var result_list = [];
            var sanzhang = 0;
            var shoupainum = 0;
            for (var k in lastcardRule) {
        ...
        ddz_sjRuleCheck.prototype.sidai1 = function (lastcardRule, userpokerRule) {
            var result_list = [];
            var sanzhang = 0;
            var shoupainum = 0;
            for (var k in lastcardRule) {
        ...
        ddz_sjRuleCheck.prototype.sanzhang2 = function (lastcardRule, userpokerRule) {
            var result_list = [];
            var sanzhang = 0;
            var shoupainum = 0;
            for (var k in lastcardRule) {
        ...
        ddz_sjRuleCheck.prototype.sanzhang1 = function (lastcardRule, userpokerRule) {
            var result_list = [];
            var sanzhang = 0;
            var shoupainum = 0;
            for (var k in lastcardRule) {
        ...
        ddz_sjRuleCheck.prototype.shunzi = function (lastcardRule, userpokerRule) {
            var result_list = [];
        ...
        ddz_sjRuleCheck.prototype.liandui = function (lastcardRule, userpokerRule) {
            var result_list = [];
        ...
        ddz_sjRuleCheck.prototype.sangle = function (lastcardRule, userpokerRule) {
            var result_list = [];
        ...
        ddz_sjRuleCheck.prototype.sangle2 = function (lastcardRule, userpokerRule) {
            var result_list = [];
            for (var k = 0; k < userpokerRule.length; k++) {
        ...
        ddz_sjRuleCheck.prototype.changnetData = function (data) {
        ...
        ddz_sjRuleCheck.prototype.getCardValue = function (card) {
        ...
        ddz_sjRuleCheck.prototype.getRealCardValue = function (card) {
            var value = Number(card.slice(3));
            if (value < 3) {
                value = value + 13;
                if (card.slice(0, 3) == "gui") {
        ...
        ddz_sjRuleCheck.prototype.sortPoker = function (pool) {
            var self = this;
            if (pool) {
        ...
        //--对2和鬼牌加权重
        ddz_sjRuleCheck.prototype.addValue = function (name) {
        ...
        ddz_sjRuleCheck.prototype.bijiaorule = function (cardType, luojiPoker, hand, lastcardType, luojilastcard) {
            var self = this;
        ...
        ddz_sjRuleCheck.prototype.panduanFeiJi = function (luojipokerUp, hand, lastcard) {
            var self = this;
            var netdata = [];
            var bijiaovalue = 0;
            var feiji_0 = 0;
        ...
        ddz_sjRuleCheck.prototype.isChuPai = function (pokerUp, handcard, lastcard) {
            var self = this;
            //   选择要出的牌 ，手牌，上家出的牌，是不是第一次出牌（首轮必出黑桃3的情况下）
            var shoupaiSelect = copy_Array(pokerUp);
            if (!(shoupaiSelect && typeof (shoupaiSelect) && shoupaiSelect.length > 0)) {
                return 1;
            }
        ...
        ddz_sjRuleCheck.prototype.getPassCardType = function (passcard) {
            var self = this;
        ...
        return ddz_sjRuleCheck;
    }());
    games.ddz_sjRuleCheck = ddz_sjRuleCheck;
})(games || (games = {}));
//# sourceMappingURL=ddz_sjRuleCheck.js.map