...
(function (games) {
    var GameCtr = /** @class */ (function () {
        ...
        GameCtr.prototype.recvData = function (cmd, data) {
        ...
        GameCtr.prototype.updateUI = function (key, data) {
            this.game.updateUI(key, data);
        };
        GameCtr.prototype.getLocation = function () {
            return this.loc;
        };
        return GameCtr;
    }());
    games.GameCtr = GameCtr;
    games.STATE = {
...
//# sourceMappingURL=GameCrl.js.map