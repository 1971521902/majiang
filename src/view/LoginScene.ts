import Login = ui.sjddz.login_shuUI;

module gameView {
    export class LoginScene implements BaseView {
        private main: Login;
        private data: Object;
        ...
        private onLoaded(): void {
            ...
            addClick(this.main.login, function (e) {
                var loginReq = function (user, passwd, code, openid, token) {    //  外网   119.29.240.253         内网   192.168.200.25
